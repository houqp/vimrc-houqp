...
syntax clear
so ~/.vim/bundle/wikipedia/syntax/Wikipedia.vim
...
imap <buffer> ,,ul <Esc>0i<space><space>*<space>
"add Unordered list in cursors' current position
imap <buffer> ,,cul <space><space>*<space>  

"adding Ordered Lists
imap <buffer> ,,ol <Esc>0i<space><space>-<space>
imap <buffer> ,,col <space><space>-<space>
